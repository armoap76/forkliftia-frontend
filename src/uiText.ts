...
export const ui = {
  en: {
    ...
    caseClosedReadOnly: "Case closed. Open a new case for new findings.",
    editCase: "Edit case",
    cancelEdit: "Cancel",
  ...
  es: {
    ...
    caseClosedReadOnly: "Caso cerrado. Abrí un caso nuevo para nuevos hallazgos.",
